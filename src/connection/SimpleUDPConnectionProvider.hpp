...
class SimpleUDPConnectionProvider : public base::Countable, public ServerConnectionProvider {
 public:
   ...
   */
  class ExtendedUDPConnection : public oatpp::base::Countable, public oatpp::data::stream::IOStream {
   public:
   ...
   protected:
    ...
    data::stream::IOMode m_in_m = data::stream::IOMode::BLOCKING;
    data::stream::IOMode m_out_m = data::stream::IOMode::BLOCKING;
   ...
   public:
     ...
     */
    ExtendedUDPConnection(v_io_handle handle, data::stream::Context::Properties&& properties);
